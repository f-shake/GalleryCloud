        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExposureTime = table.Column<string>(type: "TEXT", maxLength: 32, nullable: true),
                    Iso = table.Column<int>(type: "INTEGER", nullable: true),
                    Aperture = table.Column<string>(type: "TEXT", maxLength: 16, nullable: true),
                    FocalLength = table.Column<string>(type: "TEXT", maxLength: 16, nullable: true),
                    FocalLength35mm = table.Column<int>(type: "INTEGER", nullable: true),
