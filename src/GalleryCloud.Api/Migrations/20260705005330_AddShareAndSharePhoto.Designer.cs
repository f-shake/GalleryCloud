...
namespace GalleryCloud.Api.Migrations
{
    ...
    [Migration("20260705005330_AddShareAndSharePhoto")]
    partial class AddShareAndSharePhoto
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GalleryCloud.Core.Entities.Share", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(32)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("GalleryCloud.Core.Entities.SharePhoto", b =>
                {
                    ...
                    b.HasKey("ShareId", "PhotoId");

                    b.HasIndex("PhotoId");

                    b.ToTable("SharePhotos", (string)null);
                });
            ...
            modelBuilder.Entity("GalleryCloud.Core.Entities.SharePhoto", b =>
                {
                    ...
                    b.HasOne("GalleryCloud.Core.Entities.Share", "Share")
                        .WithMany("SharePhotos")
